...
@fModel(registryname = "frsm:models/block/furnace1b")
public class Furnace1bModel extends GenericModelBase {
	
	int textureX = 128;
	int textureY = 128;

	public Furnace1bModel(){
		...
		for(ModelRendererTurbo turbo : base) turbo.setTexture("frsm:blocks/furnace1");
		translate(0F, -24F, 0F);
	}
	
	public Collection<ResourceLocation> getTextures(Map<String, String> customdata){
		return Collections.singleton(new ResourceLocation("frsm:blocks/furnace1"));
	}
