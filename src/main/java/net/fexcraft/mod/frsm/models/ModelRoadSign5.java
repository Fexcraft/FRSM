...
public class ModelRoadSign5 extends GenericModelBase {
	
	private int textureX = 128, textureY = 64;

	public ModelRoadSign5(){
		...
		base[7].setRotationPoint(-7F, -30F, -1.6F);
		...
		base[14].setRotationPoint(-1.5F, -18F, -2F);

		base[15].addBox(0F, 0F, 0F, 12, 1, 1, 0F); // Box 15
		base[15].setRotationPoint(-6F, -31F, -2F);

		base[16].addShapeBox(0F, 0F, 0F, 1, 12, 1, 0F, -0.25F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, -0.25F, 0F, 0F, -6.5F, 0F, 0F, 6F, -1F, 0F, 6F, -1F, 0F, -6.5F, 0F, 0F); // Box 16
		base[16].setRotationPoint(-8F, -29F, -2F);

		base[17].addShapeBox(0F, 0F, 0F, 1, 12, 1, 0F, 0.25F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, 0.25F, 0F, 0F, 6F, -1F, 0F, -6.5F, 0F, 0F, -6.5F, 0F, 0F, 6F, -1F, 0F); // Box 17
		base[17].setRotationPoint(7F, -29F, -2F);

		base[18].addShapeBox(0F, 0F, 0F, 2, 1, 1, 0F, 0F, 0F, 0F, -0.25F, -2F, 0F, -0.25F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.25F, 1F, 0F, -1.25F, 1F, 0F, 0F, 0F, 0F); // Box 20
		base[18].setRotationPoint(6F, -31F, -2F);

		base[19].addShapeBox(0F, -2F, 0F, 2, 1, 1, 0F, -0.25F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.25F, -2F, 0F, -1.25F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.25F, 1F, 0F); // Box 21
		base[19].setRotationPoint(-8F, -29F, -2F);
		
		translate(0F, 14F, 0F);
	}
	
	@fTESR
	public static class Renderer extends TileRenderer4R<RoadSign5.TE> {
		
		public Renderer(){ super("frsm:textures/blocks/RoadSign5.png", new ModelRoadSign5()); }

		@Override
		public void renderModel(RoadSign5.TE tileentity, float partialticks, int destroystage){ model.render(); }
