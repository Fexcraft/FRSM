...
public class ModelRoadSign1 extends GenericModelBase {
	...
	@fTESR
	public static class Renderer extends TileRenderer4R<RoadSign1.TE> {
		
		public Renderer(){ super("frsm:textures/blocks/RoadSign1.png", new ModelRoadSign1()); }

		@Override
		public void renderModel(RoadSign1.TE tileentity, float partialticks, int destroystage){ model.render(); }
