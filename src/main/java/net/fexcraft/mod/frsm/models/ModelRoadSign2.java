...
public class ModelRoadSign2 extends GenericModelBase {
	...
	@fTESR
	public static class Renderer extends TileRenderer4R<RoadSign2.TE> {
		
		public Renderer(){ super("frsm:textures/blocks/RoadSign1.png", new ModelRoadSign2()); }

		@Override
		public void renderModel(RoadSign2.TE tileentity, float partialticks, int destroystage){ model.render(); }
