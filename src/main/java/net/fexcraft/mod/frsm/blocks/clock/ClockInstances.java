...
public class ClockInstances {
	...
	@fBlock(modid = FRSM.MODID, name = "clock1", tileentity = Clock1TE.class, item = ClockBaseItem.class)
	public static class Clock1 extends ClockBase {}
	
	@fBlock(modid = FRSM.MODID, name = "clock1c", tileentity = Clock1CTE.class, item = ClockBaseItem.class)
	public static class Clock1C extends ClockBase {}
	
	@fBlock(modid = FRSM.MODID, name = "clock1w", tileentity = Clock1WTE.class, item = ClockBaseItem.class)
	public static class Clock1W extends ClockBase {}
	
	@fBlock(modid = FRSM.MODID, name = "clock2", tileentity = Clock2TE.class, item = ClockBaseItem.class)
	public static class Clock2 extends ClockBase {}
	
	@fBlock(modid = FRSM.MODID, name = "clock2c", tileentity = Clock2CTE.class, item = ClockBaseItem.class)
	public static class Clock2C extends ClockBase {}
	
	@fBlock(modid = FRSM.MODID, name = "clock2w", tileentity = Clock2WTE.class, item = ClockBaseItem.class)
