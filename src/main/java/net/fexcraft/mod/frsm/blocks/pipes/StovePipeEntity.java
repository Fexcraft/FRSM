...
public class StovePipeEntity extends TileEntity implements IPacketReceiver<PacketTileEntityUpdate> {
	
	private boolean north, south, west, east, up, down;
	private boolean[] array;
	
	public StovePipeEntity(){
	...
	public void onChange(BlockPos change){
		if(world.getTileEntity(change) instanceof StovePipeEntity){
	...
	public void onChange(BlockPos change, boolean b){
		...
		up = world.getTileEntity(pos.up()) instanceof StovePipeEntity || world.getBlockState(pos.up()).getBlock() instanceof Connectable;
		down = world.getTileEntity(pos.down()) instanceof StovePipeEntity || world.getBlockState(pos.down()).getBlock() instanceof Connectable;
		north = world.getTileEntity(pos.north()) instanceof StovePipeEntity || world.getBlockState(pos.north()).getBlock() instanceof Connectable;
		south = world.getTileEntity(pos.south()) instanceof StovePipeEntity || world.getBlockState(pos.south()).getBlock() instanceof Connectable;
		west = world.getTileEntity(pos.west()) instanceof StovePipeEntity || world.getBlockState(pos.west()).getBlock() instanceof Connectable;
		east = world.getTileEntity(pos.east()) instanceof StovePipeEntity || world.getBlockState(pos.east()).getBlock() instanceof Connectable;
		//temp
